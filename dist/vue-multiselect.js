var VueMultiselect = (function (exports, vue) {
  ...
  const _hoisted_16 = /*#__PURE__*/vue.createTextVNode("No elements found. Consider changing the search query.");
  const _hoisted_17 = { class: "multiselect__option" };
  const _hoisted_18 = /*#__PURE__*/vue.createTextVNode("List is empty.");

  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", {
      tabindex: _ctx.searchable ? -1 : $props.tabindex,
      class: vue.normalizeClass([{ 'multiselect--active': _ctx.isOpen, 'multiselect--disabled': $props.disabled, 'multiselect--above': $options.isAbove }, "multiselect"]),
      ...
      vue.createVNode(vue.Transition, { name: "multiselect" }, {
        default: vue.withCtx(() => [
          vue.withDirectives(vue.createElementVNode("div", {
            ...
            tabindex: "-1",
            onMousedown: _cache[12] || (_cache[12] = vue.withModifiers(() => {}, ["prevent"])),
